...
if (testimonialsSl) {
    ...
    testimonialsMore.addEventListener("click", function (event) {
        testimonialsSl.classList.toggle('testimonials_row');
...
function scrollBar() {
    let scrollProgress = document.querySelector(".scroll-bar__progress");
    if (scrollProgress) {
...
;
let filterMenu = document.querySelector('.filters');
let filterOpen = document.querySelector('.filters__open');
let filterClose = document.querySelector('.filters__close');
let filterBody = document.querySelector('body');
if (filterMenu) {
    filterOpen.addEventListener('click', function () {
        filterMenu.classList.add('filters_active');
        filterBody.classList.add('body-toggle');
    });

    filterClose.addEventListener('click', function () {
        filterMenu.classList.remove('filters_active');
        filterBody.classList.remove('body-toggle');
